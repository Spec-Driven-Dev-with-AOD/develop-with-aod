...
Cover every AOD path, standing definition, binding, reaction, capability use, progress or termination rule, and environment responsibility that materially affects generated behavior. Editorial groups, comments, and implicit prefixes that require no separate implementation need no mapping.
