...
- Establish clearly determined constituent paths with their enclosing structured valued binding, not as later causal stages.
...
- Preserve controlled implicit declarations and bindings, but never invent an unclear source, projection, identity bridge, capability, or natural-language meaning.
